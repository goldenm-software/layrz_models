// InboundProtocolInput moved to layrz_sdk. Its test coverage moved with it to
// package:layrz_sdk's test suite (layrz-sdk/dart/test/inbound/protocol_input_test.dart),
// adapted to the SDK's InboundProtocolInput shape. The body below is preserved
// commented out (not deleted) for reviewability.
//
