...
/// Is the ID of the action.
 String get id;/// Is the name of the action.
 String get name;/// Is the type of the action.
@JsonKey(unknownEnumValue: ActionType.performOperation) ActionType get kind;/// Is the subtype of the action.
@JsonKey(unknownEnumValue: ActionSubtype.unused) ActionSubtype get subkind;/// Is the ID of tag to perform commands.
 String? get commandId;/// Is the list of Triggers or triggers' IDs.
 List<Trigger>? get triggers; List<String>? get triggersIds;/// Is the list of Outbound Servives or outbound services' IDs.
 List<OutboundService>? get outboundServices; List<String>? get outboundServicesIds;/// Is the list of Operations or operations' IDs.
 List<Operation>? get operations; List<String>? get operationsIds;/// Is a list of granted access to this entity.
...
/// ID of the action entity. This ID is unique.
 String? get id;/// ID of the action entity. This ID is unique.
 set id(String? value);/// Name of the action.
 String get name;/// Name of the action.
 set name(String value);/// Action type, please read the documentation of ActionType for more information about the actions.
@JsonKey(unknownEnumValue: ActionType.performOperation) ActionType get kind;/// Action type, please read the documentation of ActionType for more information about the actions.
@JsonKey(unknownEnumValue: ActionType.performOperation) set kind(ActionType value);/// Subkind
@JsonKey(unknownEnumValue: ActionSubtype.unused) ActionSubtype get subkind;/// Subkind
@JsonKey(unknownEnumValue: ActionSubtype.unused) set subkind(ActionSubtype value);/// ID of the linked Commands Tag.
 String? get commandId;/// ID of the linked Commands Tag.
 set commandId(String? value);/// List of triggers IDs enabled for handle this action.
 List<String> get triggersIds;/// List of triggers IDs enabled for handle this action.
 set triggersIds(List<String> value);/// List of opearations IDs enabled for handle this action. Only for ActionType.PERFORMOPERATION
 List<String> get operationsIds;/// List of opearations IDs enabled for handle this action. Only for ActionType.PERFORMOPERATION
 set operationsIds(List<String> value);/// List of Outbound services IDs to broadcast. Only for ActionType.SENDTOOMEGA
 List<String> get outboundServicesIds;/// List of Outbound services IDs to broadcast. Only for ActionType.SENDTOOMEGA
 set outboundServicesIds(List<String> value);/// If kind == ActionType.sendToMonitorCenter is true, this field will be used if the arriving data need image convertion.
...
@JsonKey(unknownEnumValue: ActionProperty.none) ActionProperty get whoOwner;/// [name] defines the name of the geofence to create.
/// This property is a LCL formula
 String? get name;/// [category] defines the category of the geofence to create.
@JsonKey(unknownEnumValue: GeofenceCategory.none) GeofenceCategory? get category;/// [radius] defines the radius of the geofence to create.
 double? get radius;/// [mappitRouteId] defines the route ID of the geofence to create.
 String? get mappitRouteId;/// [mappitRoute] defines the route of the geofence to create.
...
@useResult
$Res call({
@JsonKey(unknownEnumValue: ActionProperty.none) ActionProperty whoOwner, String? name,@JsonKey(unknownEnumValue: GeofenceCategory.none) GeofenceCategory? category, double? radius, String? mappitRouteId, MappitRoute? mappitRoute
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(unknownEnumValue: ActionProperty.none)  ActionProperty whoOwner,  String? name, @JsonKey(unknownEnumValue: GeofenceCategory.none)  GeofenceCategory? category,  double? radius,  String? mappitRouteId,  MappitRoute? mappitRoute)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ActionGeofenceSettings() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(unknownEnumValue: ActionProperty.none)  ActionProperty whoOwner,  String? name, @JsonKey(unknownEnumValue: GeofenceCategory.none)  GeofenceCategory? category,  double? radius,  String? mappitRouteId,  MappitRoute? mappitRoute)  $default,) {final _that = this;
switch (_that) {
case _ActionGeofenceSettings():
return $default(_that.whoOwner,_that.name,_that.category,_that.radius,_that.mappitRouteId,_that.mappitRoute);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(unknownEnumValue: ActionProperty.none)  ActionProperty whoOwner,  String? name, @JsonKey(unknownEnumValue: GeofenceCategory.none)  GeofenceCategory? category,  double? radius,  String? mappitRouteId,  MappitRoute? mappitRoute)?  $default,) {final _that = this;
switch (_that) {
case _ActionGeofenceSettings() when $default != null:
return $default(_that.whoOwner,_that.name,_that.category,_that.radius,_that.mappitRouteId,_that.mappitRoute);case _:
  return null;
...
class _ActionGeofenceSettings extends ActionGeofenceSettings {
  const _ActionGeofenceSettings({@JsonKey(unknownEnumValue: ActionProperty.none) this.whoOwner = ActionProperty.none, this.name, @JsonKey(unknownEnumValue: GeofenceCategory.none) this.category, this.radius, this.mappitRouteId, this.mappitRoute}): super._();
...
/// [whoOwner] defines who is the owner of the geofence to create.
@JsonKey(unknownEnumValue: ActionProperty.none) ActionProperty get whoOwner;/// [whoOwner] defines who is the owner of the geofence to create.
@JsonKey(unknownEnumValue: ActionProperty.none) set whoOwner(ActionProperty value);/// [name] defines the name of the geofence to create.
/// This property is a LCL formula
 String? get name;/// [name] defines the name of the geofence to create.
/// This property is a LCL formula
 set name(String? value);/// [category] defines the category of the geofence to create.
@JsonKey(unknownEnumValue: GeofenceCategory.none) GeofenceCategory get category;/// [category] defines the category of the geofence to create.
@JsonKey(unknownEnumValue: GeofenceCategory.none) set category(GeofenceCategory value);/// [radius] defines the radius of the geofence to create.
 double get radius;/// [radius] defines the radius of the geofence to create.
 set radius(double value);/// [mappitRouteId] defines the route ID of the geofence to create.
 String? get mappitRouteId;/// [mappitRouteId] defines the route ID of the geofence to create.
