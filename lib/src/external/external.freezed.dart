...
extension ExternalSourcePatterns on ExternalSource {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ExternalSource value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String name, @ColorConverter() Color color,
            bool isEnabled, List<CredentialField> requiredFields)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ExternalSource() when $default != null:
        return $default(_that.id, _that.name, _that.color, _that.isEnabled,
...
extension ExternalAccountPatterns on ExternalAccount {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ExternalAccount value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ExternalAccount() when $default != null:
        return $default(_that.id, _that.name, _that.credentials, _that.source,
            _that.sourceId, _that.access, _that.devices);
      case _:
        return orElse();
    }
  }
...
extension ExternalUnitPatterns on ExternalUnit {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ExternalUnit value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? externalId, String name, String ident,
            Map<String, dynamic> additionalFields)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _ExternalUnit() when $default != null:
        return $default(
            _that.externalId, _that.name, _that.ident, _that.additionalFields);
      case _:
        return orElse();
    }
  }
...
extension ExternalResourcePatterns on ExternalResource {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ExternalResource value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String wialonId, String name)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ExternalResource() when $default != null:
        return $default(_that.wialonId, _that.name);
      case _:
        return orElse();
    }
  }
...
extension ExternalGeofencePatterns on ExternalGeofence {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ExternalGeofence value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
