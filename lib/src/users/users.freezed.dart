...
mixin _$MfaInput {
 ...
 MfaMethod? get method; set method(MfaMethod? value); String? get token; set token(String? value); bool get isRequesting; set isRequesting(bool value);
...
mixin _$PasswordInput {
 ...
 String get currentPassword; set currentPassword(String value); String get newPassword; set newPassword(String value); String get newPasswordConfirmation; set newPasswordConfirmation(String value);
...
mixin _$ProfileInput {
 ...
 String get name; set name(String value); String get email; set email(String value); String get username; set username(String value); AvatarInput? get dynamicAvatar; set dynamicAvatar(AvatarInput? value);
...
/// [id] represents the user ID.
 ...
 String get name;/// [token] represents the user token.
 Token? get token;/// [parentId] represents the parent ID.
 String? get parentId;/// [email] represents the user email.
 String? get email;/// [username] represents the username.
 String? get username;/// [dynamicAvatar] represents the user avatar.
 Avatar? get dynamicAvatar;/// [referencesIds] represents the list of references IDs.
 List<String>? get referencesIds;/// [references] represents the list of references.
 List<Reference>? get references;/// [category] represents the user category.
 Category? get category;/// [categoryId] represents the user category ID.
 String? get categoryId;/// [mqttToken] represents the MQTT token.
@Deprecated('Use mqttConfig instead') String? get mqttToken;/// [mqttConfig] represents the MQTT configuration.
 RealtimeMqttConfig? get mqttConfig;/// [access] represents the list of granted access.
 List<Access>? get access;/// [customFields] represents the list of custom fields.
 List<CustomField>? get customFields;/// [platformAuth] represents the platform auth.
 String get platformAuth;/// [childs] represents the list of childs.
 List<User> get childs;/// [tagsIds] represents the list of tags IDs.
 List<String>? get tagsIds;/// [tags] represents the list of tags.
 List<Tag>? get tags;/// [planId] represents the plan ID.
 String? get planId;/// [allowedApps] represents the list of allowed apps.
 List<RegisteredApp>? get allowedApps;/// [mappitAssetsIds] represents the list of assets IDs.
/// This field is only for `Mappit` use.
 List<String>? get mappitAssetsIds;/// [mappitSecondaryRoutes]
 List<String>? get mappitSecondaryRoutesIds;/// [mappitAssets] represents the list of assets.
/// This field is only for `Mappit` use.
 List<Asset>? get mappitAssets;/// [historicalDaysAllowed] represents the number of days allowed to access historical data.
/// This field is only for `Mappit` use.
 int? get historicalDaysAllowed;/// [mappitExternalAccountId] represents the Mappit external account ID.
/// This field is only for `Mappit` use.
 String? get mappitExternalAccountId;/// [mappitExternalAccount] represents the Mappit external account.
/// This field is only for `Mappit` use.
 ExternalAccount? get mappitExternalAccount;/// [mfaEnabled] represents the MFA enabled flag.
 bool get mfaEnabled;/// [mfaMethods] represents the list of MFA methods.
@MfaMethodConverter() List<MfaMethod> get mfaMethods;/// [tenvioAddress] represents the Tenvio address.
 String? get tenvioAddress;/// [tenvioPhone] represents the Tenvio phone.
 String? get tenvioPhone;/// [tenvioLatitude] represents the Tenvio latitude.
 double? get tenvioLatitude;/// [tenvioLongitude] represents the Tenvio longitude.
 double? get tenvioLongitude;/// [tenvioAddressIsPlusCode] represents the Tenvio address is Plus Code.
 bool? get tenvioAddressIsPlusCode;/// [suspendedAt] represents the date when the account was suspended.
@TimestampOrNullConverter() DateTime? get suspendedAt;/// [hwModelsAnimationsIds] is the list of the IDs of the hwModels that already shown the animations.
 List<String> get hwModelsAnimationsIds;/// [brickhousePermissionTier] represents the Brickhouse permission tier for access level of an user.
 BHSPermissionTier? get brickhousePermissionTier;/// [brickhousePermissionTierId] represents the Brickhouse permission tier ID for access level of an user.
 String? get brickhousePermissionTierId;/// [brickhouseRole] represents the Brickhouse user role.
@JsonKey(unknownEnumValue: BrickhouseUserRole.unknown) BrickhouseUserRole? get brickhouseRole;/// [sdmCode] represents the SDM code.
 String? get sdmCode;/// [isLocked] represents if the user is locked.
 bool get isLocked;/// [isSuspended] represents if the users account is suspended.
