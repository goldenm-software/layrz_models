...
extension ModelInputPatterns on ModelInput {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ModelInput value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
extension HwModelPatterns on HwModel {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_HwModel value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _HwModel() when $default != null:
        return $default(_that.id, _that.name, _that.modelsIds, _that.models);
      case _:
        return orElse();
    }
  }
...
extension HwModelInputPatterns on HwModelInput {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_HwModelInput value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? id, String name, List<String> modelsIds)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _HwModelInput() when $default != null:
        return $default(_that.id, _that.name, _that.modelsIds);
      case _:
        return orElse();
    }
  }
  ...
  @optionalTypeArgs
  TResult when<TResult extends Object?>(
    TResult Function(String? id, String name, List<String> modelsIds) $default,
  ) {
    final _that = this;
    switch (_that) {
      case _HwModelInput():
...
extension FirmwareBuildPatterns on FirmwareBuild {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_FirmwareBuild value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
