...
mixin _$ReportTemplateInput {
 ...
 String? get id; set id(String? value); String get name; set name(String value); List<String> get assetsIds; set assetsIds(List<String> value); List<String> get outboundServicesIds; set outboundServicesIds(List<String> value); List<ReportTemplatePageInput> get structure; set structure(List<ReportTemplatePageInput> value);
...
/// Is the col name
 String get name;/// Is the col field name
 String get field;/// Is the visibility of the field
 bool get visible;/// Is the col custom identifier
 bool get isCustom;
...
mixin _$ReportTemplateColInput {
 ...
 String get name; set name(String value); String get field; set field(String value); bool get visible; set visible(bool value); bool get isCustom; set isCustom(bool value);
...
/// [id] is the report ID
 String get id;/// [code] is the report code
