...
/// [id] defines the key id. This ID is UUIDv4 format
 String get id;/// [code] defines the key code. This code is used to identify the key in the application.
 String get code;/// [progress] defines the key progress. This is a number between 0 and 1.
 double? get progress;/// [translations] defines the translations for the key.
 List<I18nTranslation> get translations;/// [createdAt] defines when the key was created.
@TimestampConverter() DateTime get createdAt;/// [createdBy] defines who created the key.
 Employee get createdBy;/// [updatedAt] defines when the key was updated.
@TimestampConverter() DateTime get updatedAt;/// [updatedBy] defines who updated the key.
...
mixin _$I18nTranslation {
 ...
 String get id; String get languageId; String get message;
...
/// [id] is the ID of the history entry.
 String get id;/// [language] is the language of the history entry.
 String get languageId;/// [before] is the previous value of the key.
 String get before;/// [after] is the new value of the key.
 String get after;/// [performedAt] is the date and time when the change was made.
 DateTime get performedAt;/// [performedBy] is the user who made the change.
