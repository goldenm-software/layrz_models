...
_Asset _$AssetFromJson(Map<String, dynamic> json) => _Asset(
  ...
  authenticatedAssetsIds:
      (json['authenticatedAssetsIds'] as List<dynamic>?)
          ...
          .toList(),
  authenticatedAssets:
      (json['authenticatedAssets'] as List<dynamic>?)
          ?.map((e) => Asset.fromJson(e as Map<String, dynamic>))
          .toList(),
  authenticatedUsersIds:
      (json['authenticatedUsersIds'] as List<dynamic>?)
          ...
          .toList(),
  authenticatedUsers:
      (json['authenticatedUsers'] as List<dynamic>?)
  ...
  access:
      (json['access'] as List<dynamic>?)
          ...
          .toList(),
  lastExits:
      (json['lastExits'] as List<dynamic>?)
  ...
  parameters:
      ...
      const [],
  globalSensors:
      (json['globalSensors'] as List<dynamic>?)
          ?.map((e) => Sensor.fromJson(e as Map<String, dynamic>))
          .toList(),
...
_AssetInput _$AssetInputFromJson(Map<String, dynamic> json) => _AssetInput(
  ...
  mappitLaborStartTime:
      json['mappitLaborStartTime'] == null
          ? const TimeOfDay(hour: 9, minute: 0)
          : const TimeOfDayConverter().fromJson(
            json['mappitLaborStartTime'] as String,
          ),
  mappitLaborEndTime:
      json['mappitLaborEndTime'] == null
