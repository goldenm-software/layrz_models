...
mixin _$ContactInfoInput {
 ...
 String get name; set name(String value); String get email; set email(String value); String get phone; set phone(String value);
...
@DurationConverter() Duration get online;@DurationConverter() set online(Duration value);@DurationConverter() Duration get hibernation;@DurationConverter() set hibernation(Duration value);
...
/// This field is only for `Mappit` use.
 ...
 String? get ownerId;/// [loginInfo] refers to the login inInputation of the asset.
...
@FlutterTimeOfDayOrNullConverter() TimeOfDay? get mappitLaborStartTime;/// [mappitLaborEndTime] is the time of the labor end time.
@FlutterTimeOfDayOrNullConverter() TimeOfDay? get mappitLaborEndTime;/// `geofences` is the list of geofences associated to the asset, Its implement just in [ATS].
...
mixin _$AssetInput {
 ...
 String? get id; set id(String? value); String get name; set name(String value); String? get kindId; set kindId(String? value); String get plate; set plate(String value); String get vin; set vin(String value); List<ContactInfoInput> get contacts; set contacts(List<ContactInfoInput> value); ConnectionInput get connection; set connection(ConnectionInput value);@AssetModeConverter() AssetMode get mode;@AssetModeConverter() set mode(AssetMode value); String? get primaryId; set primaryId(String? value); List<String> get authenticatedUsersIds; set authenticatedUsersIds(List<String> value); List<String> get authenticatedAssetsIds; set authenticatedAssetsIds(List<String> value); List<String> get externalIdentifiers; set externalIdentifiers(List<String> value); List<String> get devicesIds; set devicesIds(List<String> value); List<String> get childrenIds; set childrenIds(List<String> value); List<String> get referencesIds; set referencesIds(List<String> value); List<CustomFieldInput> get customFields; set customFields(List<CustomFieldInput> value); List<SensorInput> get sensors; set sensors(List<SensorInput> value); AvatarInput? get dynamicIcon; set dynamicIcon(AvatarInput? value); StaticPositionInput? get staticPosition; set staticPosition(StaticPositionInput? value); AssetLoginInfoInput? get loginInfo; set loginInfo(AssetLoginInfoInput? value); List<ZonePointInput>? get points; set points(List<ZonePointInput>? value);// ATS Specific fields
 String get nfcIdentifier;// ATS Specific fields
 set nfcIdentifier(String value); String? get authenticationCardId; set authenticationCardId(String? value); List<String> get linkedSupplyPointAssetsIds; set linkedSupplyPointAssetsIds(List<String> value); List<String> get linkedStorageTerminalsIds; set linkedStorageTerminalsIds(List<String> value); List<String> get geofencesIds; set geofencesIds(List<String> value); String? get authenticationCardCardboardId; set authenticationCardCardboardId(String? value); String? get authenticationCardTagId; set authenticationCardTagId(String? value); String? get authenticationCardNfcId; set authenticationCardNfcId(String? value);// Mapppit specific fields
 List<MappitLaborHourInput> get mappitLaborHours;// Mapppit specific fields
 set mappitLaborHours(List<MappitLaborHourInput> value);@FlutterTimeOfDayConverter() TimeOfDay get mappitLaborStartTime;@FlutterTimeOfDayConverter() set mappitLaborStartTime(TimeOfDay value);@FlutterTimeOfDayConverter() TimeOfDay get mappitLaborEndTime;@FlutterTimeOfDayConverter() set mappitLaborEndTime(TimeOfDay value); List<String> get mappitSecondaryRoutesIds; set mappitSecondaryRoutesIds(List<String> value);
...
@override@JsonKey()@FlutterTimeOfDayConverter()  TimeOfDay mappitLaborStartTime;
@override@JsonKey()@FlutterTimeOfDayConverter()  TimeOfDay mappitLaborEndTime;
...
@override $ConnectionInputCopyWith<$Res> get connection;@override $AvatarInputCopyWith<$Res>? get dynamicIcon;@override $StaticPositionInputCopyWith<$Res>? get staticPosition;@override $AssetLoginInfoInputCopyWith<$Res>? get loginInfo;
...
/// [enabled] is the login status of the asset.
 bool get enabled;/// [enabled] is the login status of the asset.
...
mixin _$StaticPositionInput {
 ...
 double? get latitude; set latitude(double? value); double? get longitude; set longitude(double? value); double? get altitude; set altitude(double? value);
