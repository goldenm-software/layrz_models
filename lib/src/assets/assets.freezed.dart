...
/// Only used in ATS apps.
 List<String>? get linkedSupplyPointAssetsIds;/// [staticPosition] refers to the static position of the asset.
...
mixin _$AssetInput {
 ...
 set nfcIdentifier(String value); String? get authenticationCardId; set authenticationCardId(String? value); List<String> get linkedSupplyPointAssetsIds; set linkedSupplyPointAssetsIds(List<String> value); List<String> get geofencesIds; set geofencesIds(List<String> value); String? get authenticationCardCardboardId; set authenticationCardCardboardId(String? value); String? get authenticationCardTagId; set authenticationCardTagId(String? value); String? get authenticationCardNfcId; set authenticationCardNfcId(String? value);// Mapppit specific fields
 List<MappitLaborHourInput> get mappitLaborHours;// Mapppit specific fields
 set mappitLaborHours(List<MappitLaborHourInput> value);@TimeOfDayConverter() TimeOfDay get mappitLaborStartTime;@TimeOfDayConverter() set mappitLaborStartTime(TimeOfDay value);@TimeOfDayConverter() TimeOfDay get mappitLaborEndTime;@TimeOfDayConverter() set mappitLaborEndTime(TimeOfDay value); List<String> get mappitSecondaryRoutesIds; set mappitSecondaryRoutesIds(List<String> value);
