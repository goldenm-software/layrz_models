...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  List<String> assetsIds,  List<String> geofencesIds,  List<String> triggersIds, @TimestampOrNullConverter()  DateTime? expiresAt,  String? customizationId,  List<String> poisIds,  String? mapLayerId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LocatorInput() when $default != null:
return $default(_that.id,_that.assetsIds,_that.geofencesIds,_that.triggersIds,_that.expiresAt,_that.customizationId,_that.poisIds,_that.mapLayerId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  List<String> assetsIds,  List<String> geofencesIds,  List<String> triggersIds, @TimestampOrNullConverter()  DateTime? expiresAt,  String? customizationId,  List<String> poisIds,  String? mapLayerId)  $default,) {final _that = this;
switch (_that) {
case _LocatorInput():
return $default(_that.id,_that.assetsIds,_that.geofencesIds,_that.triggersIds,_that.expiresAt,_that.customizationId,_that.poisIds,_that.mapLayerId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  List<String> assetsIds,  List<String> geofencesIds,  List<String> triggersIds, @TimestampOrNullConverter()  DateTime? expiresAt,  String? customizationId,  List<String> poisIds,  String? mapLayerId)?  $default,) {final _that = this;
switch (_that) {
case _LocatorInput() when $default != null:
return $default(_that.id,_that.assetsIds,_that.geofencesIds,_that.triggersIds,_that.expiresAt,_that.customizationId,_that.poisIds,_that.mapLayerId);case _:
  return null;
...
class _LocatorInput extends LocatorInput {
   _LocatorInput({this.id, this.assetsIds = const [], this.geofencesIds = const [], this.triggersIds = const [], @TimestampOrNullConverter() this.expiresAt, this.customizationId, this.poisIds = const [], this.mapLayerId}): super._();
...
/// Create a copy of LocatorInput
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? assetsIds = null,Object? geofencesIds = null,Object? triggersIds = null,Object? expiresAt = freezed,Object? customizationId = freezed,Object? poisIds = null,Object? mapLayerId = freezed,}) {
