...
@ColorOrNullConverter() Color? get color;/// Depending of the Geofence mode, this field may return one or N points. Please check the GeofenceMode definition
 List<GeofencePoint>? get path;/// Radius of the geofence in meters. If mode is GeofenceMode.LINEAR, this field will be the weight of the geofence. For GeofenceMode.POLYGON, this field will be ignored.
...
/// ID of the geofence entity. This ID is unique.
 String? get id;/// ID of the geofence entity. This ID is unique.
 set id(String? value);/// Name of the geofence.
 String get name;/// Name of the geofence.
 set name(String value);/// Description of the geofence.
 String get description;/// Description of the geofence.
 set description(String value);/// Color of the geofence in hexadecimal code.
@ColorConverter() Color get color;/// Color of the geofence in hexadecimal code.
...
@JsonKey(unknownEnumValue: GeofenceMode.radial) set mode(GeofenceMode value);/// Radius of the geofence in meters. If mode is GeofenceMode.LINEAR, this field will be the weight of the geofence. For GeofenceMode.POLYGON, this field will be ignored.
 double get radius;/// Radius of the geofence in meters. If mode is GeofenceMode.LINEAR, this field will be the weight of the geofence. For GeofenceMode.POLYGON, this field will be ignored.
 set radius(double value);/// External resource ID, only for external geofences.
 List<GeofencePointInput> get path;/// External resource ID, only for external geofences.
 set path(List<GeofencePointInput> value);/// List of assets inside the geofence.
@JsonKey(unknownEnumValue: GeofenceCategory.none) GeofenceCategory get category;/// List of assets inside the geofence.
@JsonKey(unknownEnumValue: GeofenceCategory.none) set category(GeofenceCategory value);/// List of children id geofences.
 List<String> get childrenIds;/// List of children id geofences.
 set childrenIds(List<String> value);/// List of custom fields.
 List<CustomFieldInput> get customFields;/// List of custom fields.
 set customFields(List<CustomFieldInput> value);/// Asset to which the geofence is linked.
 String? get assetId;/// Asset to which the geofence is linked.
...
mixin _$GeofencePointInput {
 ...
 double get latitude; set latitude(double value); double get longitude; set longitude(double value);
