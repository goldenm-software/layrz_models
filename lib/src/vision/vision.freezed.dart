...
extension VisionProtocolPatterns on VisionProtocol {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_VisionProtocol value)? $default, {
    ...
    switch (_that) {
      case _VisionProtocol() when $default != null:
        return $default(_that.id, _that.name, _that.color, _that.isEnabled,
            _that.requiredFields, _that.usage, _that.dynamicIcon);
      case _:
        return orElse();
    }
  }
...
extension VisionProfilePatterns on VisionProfile {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_VisionProfile value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _VisionProfile() when $default != null:
        return $default(_that.id, _that.name, _that.protocolId, _that.protocol,
            _that.config, _that.access, _that.lastMeasurement);
      case _:
        return orElse();
    }
  }
...
extension VisionGaugeResultPatterns on VisionGaugeResult {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_VisionGaugeResult value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, double result,
    ...
    switch (_that) {
      case _VisionGaugeResult() when $default != null:
        return $default(_that.id, _that.result, _that.performedAt);
      case _:
        return orElse();
    }
  }
