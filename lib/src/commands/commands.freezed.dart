...
@CommandDefinitionSourceConverter() CommandDefinitionSource get source;/// [definition] is the definition of the command.
...
@useResult
$Res call({
@CommandDefinitionSourceConverter() CommandDefinitionSource source, String definition, Map<String, dynamic>? payload
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@CommandDefinitionSourceConverter()  CommandDefinitionSource source,  String definition,  Map<String, dynamic>? payload)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CommandData() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@CommandDefinitionSourceConverter()  CommandDefinitionSource source,  String definition,  Map<String, dynamic>? payload)  $default,) {final _that = this;
switch (_that) {
case _CommandData():
return $default(_that.source,_that.definition,_that.payload);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@CommandDefinitionSourceConverter()  CommandDefinitionSource source,  String definition,  Map<String, dynamic>? payload)?  $default,) {final _that = this;
switch (_that) {
case _CommandData() when $default != null:
return $default(_that.source,_that.definition,_that.payload);case _:
  return null;
...
class _CommandData implements CommandData {
  const _CommandData({@CommandDefinitionSourceConverter() required this.source, required this.definition, final  Map<String, dynamic>? payload}): _payload = payload;
  factory _CommandData.fromJson(Map<String, dynamic> json) => _$CommandDataFromJson(json);

/// [source] is the source of the command.
@override@CommandDefinitionSourceConverter() final  CommandDefinitionSource source;
...
@CommandSourceConverter() CommandSource get source;/// [isGlobal] is a flag that indicates if the command is global or not. A global command
...
@useResult
$Res call({
 String id, String name,@CommandSourceConverter() CommandSource source, bool isGlobal, String? payload, String? tagId, String? deviceId, String? protocolId, InboundProtocol? protocol, String? modelId, Model? model, String? definition, String? externalAccountId, CommandData? data, ModbusParameter? modbusParameter, String? modbusPort, List<Access>? access, List<Device>? possibleDevices
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name, @CommandSourceConverter()  CommandSource source,  bool isGlobal,  String? payload,  String? tagId,  String? deviceId,  String? protocolId,  InboundProtocol? protocol,  String? modelId,  Model? model,  String? definition,  String? externalAccountId,  CommandData? data,  ModbusParameter? modbusParameter,  String? modbusPort,  List<Access>? access,  List<Device>? possibleDevices)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DeviceCommand() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name, @CommandSourceConverter()  CommandSource source,  bool isGlobal,  String? payload,  String? tagId,  String? deviceId,  String? protocolId,  InboundProtocol? protocol,  String? modelId,  Model? model,  String? definition,  String? externalAccountId,  CommandData? data,  ModbusParameter? modbusParameter,  String? modbusPort,  List<Access>? access,  List<Device>? possibleDevices)  $default,) {final _that = this;
switch (_that) {
case _DeviceCommand():
return $default(_that.id,_that.name,_that.source,_that.isGlobal,_that.payload,_that.tagId,_that.deviceId,_that.protocolId,_that.protocol,_that.modelId,_that.model,_that.definition,_that.externalAccountId,_that.data,_that.modbusParameter,_that.modbusPort,_that.access,_that.possibleDevices);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name, @CommandSourceConverter()  CommandSource source,  bool isGlobal,  String? payload,  String? tagId,  String? deviceId,  String? protocolId,  InboundProtocol? protocol,  String? modelId,  Model? model,  String? definition,  String? externalAccountId,  CommandData? data,  ModbusParameter? modbusParameter,  String? modbusPort,  List<Access>? access,  List<Device>? possibleDevices)?  $default,) {final _that = this;
switch (_that) {
case _DeviceCommand() when $default != null:
return $default(_that.id,_that.name,_that.source,_that.isGlobal,_that.payload,_that.tagId,_that.deviceId,_that.protocolId,_that.protocol,_that.modelId,_that.model,_that.definition,_that.externalAccountId,_that.data,_that.modbusParameter,_that.modbusPort,_that.access,_that.possibleDevices);case _:
  return null;
...
class _DeviceCommand implements DeviceCommand {
  const _DeviceCommand({required this.id, required this.name, @CommandSourceConverter() required this.source, this.isGlobal = false, this.payload, this.tagId, this.deviceId, this.protocolId, this.protocol, this.modelId, this.model, this.definition, this.externalAccountId, this.data, this.modbusParameter, this.modbusPort, final  List<Access>? access, final  List<Device>? possibleDevices}): _access = access,_possibleDevices = possibleDevices;
...
@override@CommandSourceConverter() final  CommandSource source;
...
/// [source] is the source of the command.
@CommandDefinitionSourceOrNullConverter() CommandDefinitionSource? get source;/// [source] is the source of the command.
@CommandDefinitionSourceOrNullConverter() set source(CommandDefinitionSource? value);/// [definition] is the definition of the command.
...
@useResult
$Res call({
@CommandDefinitionSourceOrNullConverter() CommandDefinitionSource? source, String? definition, Map<String, dynamic> payload
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@CommandDefinitionSourceOrNullConverter()  CommandDefinitionSource? source,  String? definition,  Map<String, dynamic> payload)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CommandDataInput() when $default != null:
return $default(_that.source,_that.definition,_that.payload);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@CommandDefinitionSourceOrNullConverter()  CommandDefinitionSource? source,  String? definition,  Map<String, dynamic> payload)  $default,) {final _that = this;
switch (_that) {
case _CommandDataInput():
return $default(_that.source,_that.definition,_that.payload);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@CommandDefinitionSourceOrNullConverter()  CommandDefinitionSource? source,  String? definition,  Map<String, dynamic> payload)?  $default,) {final _that = this;
switch (_that) {
case _CommandDataInput() when $default != null:
return $default(_that.source,_that.definition,_that.payload);case _:
  return null;
...
class _CommandDataInput implements CommandDataInput {
   _CommandDataInput({@CommandDefinitionSourceOrNullConverter() this.source, this.definition, this.payload = const {}});
  factory _CommandDataInput.fromJson(Map<String, dynamic> json) => _$CommandDataInputFromJson(json);

/// [source] is the source of the command.
@override@CommandDefinitionSourceOrNullConverter()  CommandDefinitionSource? source;
/// [definition] is the definition of the command.
...
mixin _$CommandInput {
 ...
 String? get id; set id(String? value);/// Is name of the command. (Only reference, does not affect the command itself)
...
@CommandSourceOrNullConverter() CommandSource? get source;/// Is the source of the command.
@CommandSourceOrNullConverter() set source(CommandSource? value);/// [payload] is the text payload to send into a SMS command.
...
/// Only will comes when the command comes from the asset or device query.
 set deviceId(String? value);/// Is the [protocol], [protocolId] and the [model], [modelId] of the command.
/// Only will comes when the command is a "template"
 String? get protocolId;/// Is the [protocol], [protocolId] and the [model], [modelId] of the command.
/// Only will comes when the command is a "template"
 set protocolId(String? value);/// Is the [protocol], [protocolId] and the [model], [modelId] of the command.
/// Only will comes when the command is a "template"
 String? get modelId;/// Is the [protocol], [protocolId] and the [model], [modelId] of the command.
/// Only will comes when the command is a "template"
...
@useResult
$Res call({
 String? id, String name,@CommandSourceOrNullConverter() CommandSource? source, String? payload, String? tagId, String? deviceId, String? protocolId, String? modelId, String? externalAccountId, CommandDataInput? data, ModbusParameterInput? modbusParameter, String? modbusPort
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String name, @CommandSourceOrNullConverter()  CommandSource? source,  String? payload,  String? tagId,  String? deviceId,  String? protocolId,  String? modelId,  String? externalAccountId,  CommandDataInput? data,  ModbusParameterInput? modbusParameter,  String? modbusPort)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CommandInput() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  String name, @CommandSourceOrNullConverter()  CommandSource? source,  String? payload,  String? tagId,  String? deviceId,  String? protocolId,  String? modelId,  String? externalAccountId,  CommandDataInput? data,  ModbusParameterInput? modbusParameter,  String? modbusPort)  $default,) {final _that = this;
switch (_that) {
case _CommandInput():
return $default(_that.id,_that.name,_that.source,_that.payload,_that.tagId,_that.deviceId,_that.protocolId,_that.modelId,_that.externalAccountId,_that.data,_that.modbusParameter,_that.modbusPort);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  String name, @CommandSourceOrNullConverter()  CommandSource? source,  String? payload,  String? tagId,  String? deviceId,  String? protocolId,  String? modelId,  String? externalAccountId,  CommandDataInput? data,  ModbusParameterInput? modbusParameter,  String? modbusPort)?  $default,) {final _that = this;
switch (_that) {
case _CommandInput() when $default != null:
return $default(_that.id,_that.name,_that.source,_that.payload,_that.tagId,_that.deviceId,_that.protocolId,_that.modelId,_that.externalAccountId,_that.data,_that.modbusParameter,_that.modbusPort);case _:
  return null;
...
class _CommandInput implements CommandInput {
   _CommandInput({this.id, this.name = '', @CommandSourceOrNullConverter() this.source, this.payload, this.tagId, this.deviceId, this.protocolId, this.modelId, this.externalAccountId, this.data, this.modbusParameter, this.modbusPort});
...
/// Is the source of the command.
@override@CommandSourceOrNullConverter()  CommandSource? source;
/// [payload] is the text payload to send into a SMS command.
