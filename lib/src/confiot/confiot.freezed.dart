...
extension ConfIoTFilePatterns on ConfIoTFile {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ConfIoTFile value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@ConfIoTNamespaceConverter() ConfIoTNamespace namespace,
            int rev, List<Map<String, dynamic>>? configuration)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ConfIoTFile() when $default != null:
        return $default(_that.namespace, _that.rev, _that.configuration);
      case _:
        return orElse();
    }
  }
