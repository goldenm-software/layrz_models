...
_Trigger _$TriggerFromJson(Map<String, dynamic> json) => _Trigger(
      ...
      authTagsIds: (json['authTagsIds'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      kind: $enumDecode(_$TriggerTypeEnumMap, json['kind'],
          unknownValue: TriggerType.presenceInGeofences),
      geofenceKind: $enumDecodeNullable(
          _$TriggerGeofenceDetectionModeEnumMap, json['geofenceKind'],
      ...
      visualEventEffect: $enumDecodeNullable(
          _$CaseEventEffectEnumMap, json['visualEventEffect'],
      ...
      caseKind: $enumDecodeNullable(_$CaseTypeEnumMap, json['caseKind'],
          unknownValue: CaseType.onFollow),
      caseCommentPattern: $enumDecodeNullable(
          _$CaseCommentPatternEnumMap, json['caseCommentPattern'],
...
_TriggerInput _$TriggerInputFromJson(Map<String, dynamic> json) =>
    _TriggerInput(
      id: json['id'] as String?,
      name: json['name'] as String?,
      code: json['code'] as String?,
      timezoneId: json['timezoneId'] as String?,
      kind: $enumDecodeNullable(_$TriggerTypeEnumMap, json['kind'],
...
_TriggerActivation _$TriggerActivationFromJson(Map<String, dynamic> json) =>
    _TriggerActivation(
      ...
      presenceType: $enumDecodeNullable(
          _$TriggerGeofenceDetectionModeEnumMap, json['presenceType'],
