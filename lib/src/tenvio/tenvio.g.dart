...
_TenvioItemMovement _$TenvioItemMovementFromJson(Map<String, dynamic> json) =>
    _TenvioItemMovement(
      ...
      receivedBy:
          json['receivedBy'] == null
              ? null
              : User.fromJson(json['receivedBy'] as Map<String, dynamic>),
      triggeredAt: const TimestampConverter().fromJson(
        json['triggeredAt'] as num,
      ),
    );
...
_TenvioCustomProperty _$TenvioCustomPropertyFromJson(
  ...
  dataType: const TenvioPropertyDataTypeConverter().fromJson(
...
Map<String, dynamic> _$TenvioCustomPropertyToJson(
  ...
  'name': instance.name,
  'dataType': const TenvioPropertyDataTypeConverter().toJson(instance.dataType),
...
_TenvioCustomPropertyInput _$TenvioCustomPropertyInputFromJson(
  ...
  dataType:
      json['dataType'] == null
          ...
          : const TenvioPropertyDataTypeConverter().fromJson(
            json['dataType'] as String,
          ),
  isRequired: json['isRequired'] as bool? ?? false,
  choices:
...
_TenvioPackage _$TenvioPackageFromJson(
  Map<String, dynamic> json,
) => _TenvioPackage(
  id: json['id'] as String,
  ...
  items:
      (json['items'] as List<dynamic>?)
          ...
          .toList(),
  destinationType: const TenvioDestinationTypeOrNullConverter().fromJson(
    json['destinationType'] as String?,
  ),
  destinationWarehouse:
      json['destinationWarehouse'] == null
          ? null
          : Asset.fromJson(
  ...
  destinationUnregistered:
      json['destinationUnregistered'] == null
          ? null
          : TenvioUnregisteredUser.fromJson(
            json['destinationUnregistered'] as Map<String, dynamic>,
          ),
  status: const TenvioPackageStatusConverter().fromJson(
...
Map<String, dynamic> _$TenvioPackageToJson(_TenvioPackage instance) =>
    <String, dynamic>{
      ...
      'destinationType': const TenvioDestinationTypeOrNullConverter().toJson(
...
_TenvioItemQuantity _$TenvioItemQuantityFromJson(Map<String, dynamic> json) =>
    _TenvioItemQuantity(
      ...
      matrix:
          json['matrix'] == null
              ? null
              : TenvioMatrixItem.fromJson(
                json['matrix'] as Map<String, dynamic>,
              ),
    );
...
_TenvioItem _$TenvioItemFromJson(Map<String, dynamic> json) => _TenvioItem(
  ...
  matrix:
      json['matrix'] == null
          ? null
          : TenvioMatrixItem.fromJson(json['matrix'] as Map<String, dynamic>),
  location: const TenvioItemLocationOrNullConverter().fromJson(
    json['location'] as String?,
  ),
  address: json['address'] as String?,
  pickupDate: const TimestampOrNullConverter().fromJson(
    json['pickupDate'] as num?,
  ),
...
Map<String, dynamic> _$TenvioItemToJson(
  _TenvioItem instance,
) => <String, dynamic>{
  'id': instance.id,
  'matrixId': instance.matrixId,
  'matrix': instance.matrix?.toJson(),
  'location': const TenvioItemLocationOrNullConverter().toJson(
    instance.location,
  ),
  'address': instance.address,
  'pickupDate': const TimestampOrNullConverter().toJson(instance.pickupDate),
    ...
    _TenvioItemInput(
      ...
      location:
          json['location'] == null
              ...
              : const TenvioItemLocationConverter().fromJson(
                json['location'] as String,
              ),
      address: json['address'] as String?,
      pickupDate: const TimestampOrNullConverter().fromJson(
...
Map<String, dynamic> _$TenvioItemInputToJson(
  _TenvioItemInput instance,
) => <String, dynamic>{
  'id': instance.id,
  'matrixId': instance.matrixId,
    ...
    _TenvioMatrixItem(
      ...
      customProperties:
          (json['customProperties'] as List<dynamic>?)
              ?.map(
                (e) => TenvioCustomProperty.fromJson(e as Map<String, dynamic>),
              )
              .toList(),
      createdAt: const TimestampOrNullConverter().fromJson(
        json['createdAt'] as num?,
...
Map<String, dynamic> _$TenvioMatrixItemInputToJson(
  ...
  'width': instance.width,
  'height': instance.height,
  'customProperties': instance.customProperties.map((e) => e.toJson()).toList(),
};
...
_TenvioOrder _$TenvioOrderFromJson(Map<String, dynamic> json) => _TenvioOrder(
  ...
  warehouseId: json['warehouseId'] as String,
  qrCode: json['qrCode'] as String?,
  status: const TenvioOrderStatusConverter().fromJson(json['status'] as String),
  destinationType: const TenvioDestinationTypeOrNullConverter().fromJson(
    json['destinationType'] as String?,
  ),
  destinationWarehouse:
  ...
  packers:
      (json['packers'] as List<dynamic>?)
          ?.map((e) => User.fromJson(e as Map<String, dynamic>))
          .toList(),
  packersIds:
      (json['packersIds'] as List<dynamic>?)?.map((e) => e as String).toList(),
  itemQuantities:
      (json['itemQuantities'] as List<dynamic>?)
  ...
  statusPhotos:
      (json['statusPhotos'] as List<dynamic>?)
...
Map<String, dynamic> _$TenvioOrderToJson(
  _TenvioOrder instance,
) => <String, dynamic>{
  'id': instance.id,
...
_TenvioOrderInput _$TenvioOrderInputFromJson(
  Map<String, dynamic> json,
) => _TenvioOrderInput(
  id: json['id'] as String?,
  warehouseId: json['warehouseId'] as String?,
  ...
  packersIds:
      (json['packersIds'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  itemQuantities:
      (json['itemQuantities'] as List<dynamic>?)
          ?.map(
            (e) => TenvioItemQuantityInput.fromJson(e as Map<String, dynamic>),
          )
          .toList() ??
      const [],
);
...
_TenvioDispatchGuide _$TenvioDispatchGuideFromJson(Map<String, dynamic> json) =>
    _TenvioDispatchGuide(
      id: json['id'] as String,
      status: const TenvioDispatchGuideStatusConverter().fromJson(
        json['status'] as String,
      ),
      qrCode: json['qrCode'] as String?,
      warehouse:
      ...
      packages:
          ...
          const [],
      packagesIds:
          (json['packagesIds'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const [],
...
Map<String, dynamic> _$TenvioDispatchGuideToJson(
  ...
  'id': instance.id,
  'status': const TenvioDispatchGuideStatusConverter().toJson(instance.status),
  'qrCode': instance.qrCode,
  'warehouse': instance.warehouse?.toJson(),
  'warehouseId': instance.warehouseId,
  'driver': instance.driver?.toJson(),
...
_TenvioDispatchGuideInput _$TenvioDispatchGuideInputFromJson(
  ...
  status:
      json['status'] == null
          ...
          : const TenvioDispatchGuideStatusConverter().fromJson(
            json['status'] as String,
          ),
  driverId: json['driverId'] as String?,
  loaderId: json['loaderId'] as String?,
