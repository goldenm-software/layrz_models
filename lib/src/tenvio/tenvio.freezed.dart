...
mixin _$TenvioMatrixItem {
  ...
  /// [barcode] is the barcode of the item, this contains the code of the item.
...
class _$TenvioMatrixItemImpl implements _TenvioMatrixItem {
  ...
  @override
  String toString() {
    return 'TenvioMatrixItem(id: $id, name: $name, image: $image, code: $code, barcode: $barcode, weight: $weight, width: $width, height: $height, customProperties: $customProperties, createdAt: $createdAt, updatedAt: $updatedAt, items: $items)';
  }
...
class _$TenvioPackageImpl implements _TenvioPackage {
  ...
  @override
  String toString() {
    return 'TenvioPackage(id: $id, packerId: $packerId, packer: $packer, trackingId: $trackingId, warehouseId: $warehouseId, warehouse: $warehouse, items: $items, itemsIds: $itemsIds, status: $status, createdAt: $createdAt, updatedAt: $updatedAt, barcode: $barcode)';
  }
...
abstract class _TenvioPackage implements TenvioPackage {
  const factory _TenvioPackage(
      ...
      final String? barcode}) = _$TenvioPackageImpl;
