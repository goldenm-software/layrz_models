...
const _$ApiStatusEnumMap = {
  ...
  ApiStatus.accessDenied: 'ACCESS_DENIED',
  ApiStatus.movedPermanently: 'MOVED_PERMANENTLY',
  ApiStatus.badRequest: 'BAD_REQUEST',
  ApiStatus.iAmATeapot: 'IAMATEAPOT',
  ApiStatus.paymentRequired: 'PAYMENT_REQUIRED',
  ApiStatus.serviceUnavailable: 'SERVICE_UNAVAILABLE',
