...
@JsonKey(unknownEnumValue: SensorSubType.raw) SensorSubType? get subtype;/// [parameter] of the sensor.
 String? get parameter; List<String>? get externalIdentifiers;/// [formula] is the LCL formula to execute.
 String? get formula;/// [script] is the script to execute.
 String? get script;/// Only for [SensorType.unpack] and [SensorSubType.csv], [hasHeaders], [csvHeaders] and [csvSeparator] means the configuration
...
/// [hasHeaders] is a boolean to indicate if the CSV has headers inside of the message.
 bool? get hasHeaders;/// [csvHeaders] is a list of strings to indicate the names of the columns of the CSV. Only when [hasHeaders] is true.
...
/// It's a list of [SensorPair] objects.
 ...
 List<MaskPoint>? get mask;/// [hasValidator] is a boolean to indicate if the sensor has a [double] validator. When true, [minValur] and [maxValue]
...
/// So, this sensor was created from the Golden M, and their authorized you to use it.
 ...
 bool get isGlobal;/// Is the list of granted access
...
mixin _$SensorRangeInput {
 ...
 double get x; set x(double value); double get y; set y(double value);
