...
/// Is the ID of the operation.
 String get id;/// Is the name of the operation.
 String get name;/// Is the type of operation.
@JsonKey(unknownEnumValue: OperationType.unknown) OperationType get operationType;/// Is the HTTP Request type to perform
/// This field will only be considered in the following [operationType]:
/// - [OperationType.webhook].
@JsonKey(unknownEnumValue: HttpRequestType.httpGet) HttpRequestType? get requestType;/// Is the URL to perform the request
/// This field will only be considered in the following [operationType]:
/// - [OperationType.webhook].
 String? get url;/// Is the headers to send in the HTTP request
/// This field will only be considered in the following [operationType]:
/// - [OperationType.webhook].
...
/// This field will only be considered in the following [operationType]:
/// - [OperationType.email].
 String? get emailSubject;/// Is the color of the inline notification
/// This field will only be considered in the following [operationType]:
/// - [OperationType.inAppNotification].
@ColorOrNullConverter() Color? get color;/// Is the text color of the inline notification
/// This field will only be considered in the following [operationType]:
/// - [OperationType.inAppNotification].
@ColorOrNullConverter() Color? get textColor;/// Is the receiver numbers to send the message
/// This field will only be considered in the following [operationType]:
/// - [OperationType.twilio].
 List<PhoneNumber>? get destinationPhones;/// Is the Notification type to perform
/// This field will only be considered in the following [operationType]:
/// - [OperationType.twilio]
@JsonKey(unknownEnumValue: NotificationType.unknown) NotificationType? get notificationType;/// The [externalAccountId] of the operation. Only the ID
 String? get externalAccountId;/// Is the list of granted access of the operation.
 List<Access>? get access;/// Is the list of associated triggers (directly or indirectly) of the operation.
 List<Trigger>? get triggers;/// [useAssetContactsInstead] is a flag to use the asset contacts instead of the submission contacts.
 bool? get useAssetContactsInstead;/// [attachImage] is a flag to attach the image of the submission to the email.
 bool? get attachImage;/// The [emailTemplateId] of the operation. Only the ID
 String? get emailTemplateId;/// [pushPlatforms] is the list of platforms where the operation should be received.
/// This field will only be considered in the following [operationType]:
/// - [OperationType.bhsPush]
@JsonKey(unknownEnumValue: AppPlatform.web) List<AppPlatform>? get pushPlatforms;/// [pushTitle] is the title of the push notification.
/// This field will only be considered in the following [operationType]:
/// - [OperationType.bhsPush]
 String? get pushTitle;/// [soundEffect] is the sound effect to play when the notification arrives.
///
/// This will only be considered if the [operationType] is set to `OperationType.inAppNotification`.
@JsonKey(unknownEnumValue: SoundEffect.none) SoundEffect get soundEffect;/// [soundEffectUri] is the URI of the sound effect to play when the notification arrives.
///
/// This will only be considered if the [operationType] is set to `OperationType.inAppNotification`.
 String? get soundEffectUri;/// [icon] is the icon of the notification
///
/// This will only be considered if the [operationType] is set to `OperationType.inAppNotification`.
...
@DurationOrNullConverter() Duration? get duration;/// [layrzTemplate] is the content SID to use for [OperationType.sms] and [OperationType.whatsappMessage].
 String? get layrzTemplate;/// [appId] binds PUSH_NOTIFICATION-type operations to a RegisteredApp via its ID; set via mutation
 String? get appId;
...
/// Is the ID of the operation.
 String? get id;/// Is the ID of the operation.
 set id(String? value);/// Is the name of the operation.
 String get name;/// Is the name of the operation.
 set name(String value);/// Is the type of operation.
@JsonKey(unknownEnumValue: OperationType.unknown) OperationType get operationType;/// Is the type of operation.
@JsonKey(unknownEnumValue: OperationType.unknown) set operationType(OperationType value);/// Is the HTTP Request type to perform
/// This field will only be considered in the following [operationType]:
/// - [OperationType.webhook].
@JsonKey(unknownEnumValue: HttpRequestType.httpGet) HttpRequestType? get requestType;/// Is the HTTP Request type to perform
/// This field will only be considered in the following [operationType]:
/// - [OperationType.webhook].
@JsonKey(unknownEnumValue: HttpRequestType.httpGet) set requestType(HttpRequestType? value);/// Is the URL to perform the request
/// This field will only be considered in the following [operationType]:
/// - [OperationType.webhook].
 String? get url;/// Is the URL to perform the request
/// This field will only be considered in the following [operationType]:
/// - [OperationType.webhook].
 set url(String? value);/// Is the headers to send in the HTTP request
/// This field will only be considered in the following [operationType]:
/// - [OperationType.webhook].
 List<HttpHeaderInput> get headers;/// Is the headers to send in the HTTP request
/// This field will only be considered in the following [operationType]:
/// - [OperationType.webhook].
 set headers(List<HttpHeaderInput> value);/// Is the payload to send in the submission.
...
/// This field will only be considered in the following [operationType]:
/// - [OperationType.email].
 set receptionEmails(List<String> value);/// Is the subject of the email
/// This field will only be considered in the following [operationType]:
/// - [OperationType.email].
 String get emailSubject;/// Is the subject of the email
/// This field will only be considered in the following [operationType]:
/// - [OperationType.email].
 set emailSubject(String value);/// Is the color of the inline notification
/// This field will only be considered in the following [operationType]:
/// - [OperationType.inAppNotification].
@ColorOrNullConverter() Color? get color;/// Is the color of the inline notification
/// This field will only be considered in the following [operationType]:
/// - [OperationType.inAppNotification].
@ColorOrNullConverter() set color(Color? value);/// Is the text color of the inline notification
/// This field will only be considered in the following [operationType]:
/// - [OperationType.inAppNotification].
@ColorOrNullConverter() Color? get textColor;/// Is the text color of the inline notification
/// This field will only be considered in the following [operationType]:
/// - [OperationType.inAppNotification].
@ColorOrNullConverter() set textColor(Color? value);/// Is the receiver numbers to send the message
/// This field will only be considered in the following [operationType]:
/// - [OperationType.twilio].
 List<PhoneNumberInput> get destinationPhones;/// Is the receiver numbers to send the message
/// This field will only be considered in the following [operationType]:
/// - [OperationType.twilio].
 set destinationPhones(List<PhoneNumberInput> value);/// Is the Notification type to perform
/// This field will only be considered in the following [operationType]:
/// - [OperationType.twilio]
@JsonKey(unknownEnumValue: NotificationType.unknown) NotificationType? get notificationType;/// Is the Notification type to perform
/// This field will only be considered in the following [operationType]:
/// - [OperationType.twilio]
@JsonKey(unknownEnumValue: NotificationType.unknown) set notificationType(NotificationType? value);/// The [externalAccountId] of the operation. Only the ID
 String? get externalAccountId;/// The [externalAccountId] of the operation. Only the ID
 ...
 set useAssetContactsInstead(bool value);/// [attachImage] is a flag to attach the image of the submission to the email.
 bool get attachImage;/// [attachImage] is a flag to attach the image of the submission to the email.
 set attachImage(bool value);/// The [emailTemplateId] of the operation. Only the ID
 String? get emailTemplateId;/// The [emailTemplateId] of the operation. Only the ID
...
/// This field will only be considered in the following [operationType]:
/// - [OperationType.bhsPush]
@JsonKey(unknownEnumValue: AppPlatform.web) set pushPlatforms(List<AppPlatform>? value);/// [pushTitle] is the title of the push notification.
/// This field will only be considered in the following [operationType]:
/// - [OperationType.bhsPush]
 String? get pushTitle;/// [pushTitle] is the title of the push notification.
/// This field will only be considered in the following [operationType]:
/// - [OperationType.bhsPush]
 set pushTitle(String? value);/// [soundEffect] is the sound effect to play when the notification arrives.
///
/// This will only be considered if the [operationType] is set to `OperationType.inAppNotification`.
@JsonKey(unknownEnumValue: SoundEffect.none) SoundEffect get soundEffect;/// [soundEffect] is the sound effect to play when the notification arrives.
///
/// This will only be considered if the [operationType] is set to `OperationType.inAppNotification`.
@JsonKey(unknownEnumValue: SoundEffect.none) set soundEffect(SoundEffect value);/// [soundEffectUri] is the URI of the sound effect to play when the notification arrives.
///
/// This will only be considered if the [operationType] is set to `OperationType.inAppNotification`.
 String? get soundEffectUri;/// [soundEffectUri] is the URI of the sound effect to play when the notification arrives.
///
/// This will only be considered if the [operationType] is set to `OperationType.inAppNotification`.
 set soundEffectUri(String? value);/// [icon] is the icon of the notification
///
/// This will only be considered if the [operationType] is set to `OperationType.inAppNotification`.
@IconOrNullConverter() LayrzIcon? get icon;/// [icon] is the icon of the notification
///
/// This will only be considered if the [operationType] is set to `OperationType.inAppNotification`.
@IconOrNullConverter() set icon(LayrzIcon? value);/// [duration] is the duration of the notification
///
/// This will only be considered if the [operationType] is set to `OperationType.inAppNotification`.
...
@DurationConverter() set duration(Duration value);/// [layrzTemplate] is the content SID to use for [OperationType.sms] and [OperationType.whatsappMessage].
 ...
 set layrzTemplate(String? value);/// [appId] binds PUSH_NOTIFICATION-type operations to a RegisteredApp via its ID; set via mutation
 String? get appId;/// [appId] binds PUSH_NOTIFICATION-type operations to a RegisteredApp via its ID; set via mutation
...
mixin _$HttpHeaderInput {
 ...
 String get name; set name(String value); String get value; set value(String value);
