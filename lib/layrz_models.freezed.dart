...
/// @nodoc
@JsonSerializable()
class _CareProtocol implements CareProtocol {
  const _CareProtocol(
      {required this.id,
      required this.name,
...
/// @nodoc
@JsonSerializable()
class _ReportTemplate implements ReportTemplate {
...
/// @nodoc
@JsonSerializable()
class _ReportTemplatePage implements ReportTemplatePage {
...
/// @nodoc
@JsonSerializable()
class _ReportTemplateCol implements ReportTemplateCol {
...
/// @nodoc
@JsonSerializable()
class _CustomReport implements CustomReport {
  const _CustomReport(
      {required this.id,
      required this.code,
